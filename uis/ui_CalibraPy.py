...
################################################################################
## Form generated from reading UI file 'CalibraPyeYhDlB.ui'
##
...
class Ui_CalibraPy(object):
    ...
    def retranslateUi(self, CalibraPy):
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.widget_12.setToolTip(QCoreApplication.translate("CalibraPy",
                                                             u"<html><head/><body><p>Existe um delay da comunica\u00e7\u00e3o serial arduino de cerca de 4 segundos. Ajuste esse tempo a partir dos dados obtidos.</p></body></html>",
                                                             None))
        # endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("CalibraPy",
                                                      u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:700;\">Tempo de atraso</span></p></body></html>",
                                                      None))
        # if QT_CONFIG(tooltip)
        self.delay_ajuste.setToolTip(
            QCoreApplication.translate("CalibraPy", u"<html><head/><body><p><br/></p></body></html>", None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        ...
        self.dinamica_combo.setItemText(3, QCoreApplication.translate("CalibraPy",
                                                                      u"Segunda ordem criticamente amortecido", None))
        self.dinamica_combo.setItemText(4,
